...
Shader "PortalShock"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_519_0 = ( ( ase_worldPos.y * ( _BendStrength / 100.0 ) ) + 1.0 );
			float temp_output_520_0 = ( temp_output_519_0 * temp_output_519_0 );
			float temp_output_522_0 = ( ( temp_output_520_0 * temp_output_520_0 ) - temp_output_520_0 );
			float2 break526 = ( temp_output_522_0 * _Direction );
			float4 appendResult525 = (float4(break526.x , 0.0 , break526.y , 0.0));
			float3 objToWorld531 = mul( unity_ObjectToWorld, float4( ( float4( ase_worldPos , 0.0 ) + appendResult525 ).xyz, 1 ) ).xyz;
			v.vertex.xyz += objToWorld531;
		}
...
/*ASEBEGIN
Version=18400
276;75;687;765;-2119.182;913.2438;1.983089;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;513;3057.688,-1096.191;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;516;3224.243,-894.5762;Inherit;False;Property;_BendStrength;BendStrength;15;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;514;3453.615,-1081.451;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleDivideOpNode;517;3413.89,-898.5684;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;515;3690.866,-1030.319;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;519;3985.556,-1116.013;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;520;4120.001,-1123.915;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;521;4198.614,-1241.723;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;522;4302.149,-1105.151;Inherit;False;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;523;4298.324,-831.4678;Inherit;False;Property;_Direction;Direction;14;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;524;4560.273,-720.5699;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.BreakToComponentsNode;526;4632.75,-869.2264;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.WorldPosInputsNode;528;4731.409,-1226.545;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;525;4917.772,-847.6574;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;530;5118.501,-942.3779;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TransformPositionNode;532;3261.251,-1265.771;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;161;-2130.456,489.8557;Inherit;False;Waving Vertex;-1;;40;872b3757863bb794c96291ceeebfb188;0;3;1;FLOAT3;0,0,0;False;12;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TransformPositionNode;531;5444.704,-1006.112;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TFHCRemapNode;518;5360.973,-808.933;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;527;4515.161,-1269.302;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;0;11;531;0
ASEEND*/
//CHKSM=ABF18E0E23DAA7E7BAD091AF648BFF30818A7E11